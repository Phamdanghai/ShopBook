...
//    private final String SEAR_PAGE = "search.html";
//    private final String SHOW_RESULT_PAGE = "search.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = siteMap.getProperty(
                MyApplicationConstant.SearchLastNameFeatures.SEAR_PAGE);
        try {
            if (!searchValue.trim().isEmpty()) {
                ...
                url = siteMap.getProperty(
                        MyApplicationConstant.SearchLastNameFeatures.SHOW_RESULT_PAGE);
